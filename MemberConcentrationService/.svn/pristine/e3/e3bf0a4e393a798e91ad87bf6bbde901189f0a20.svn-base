...
public class MemberRegisterUpdate {
	...
	public @ResponseBody String memberregisterupdate(String postdata, HttpServletRequest request, HttpServletResponse response){
		...
		try {
			...
			log.info("接口必要参数名：member----placeno----verifyInfo********传入参数：" + jsonbean);
			...
			vo = memberregisterservice.memberRegisterUpdate(jsonbean);
