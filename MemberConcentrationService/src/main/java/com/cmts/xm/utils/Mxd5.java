...
public class Mxd5 {
	...
	public static void main(String[] args) {
		Mxd5 md5 = new Mxd5();
		try {
			System.out.println(md5.getMD5ofStr(URLEncoder.encode("", "GB2312")).toLowerCase());
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
